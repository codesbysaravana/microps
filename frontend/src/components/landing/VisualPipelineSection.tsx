              ...
              >
                <div className="flex items-center gap-4">
                  <div className={`w-7 h-7 rounded-full flex items-center justify-center font-bold text-[11px] ${
                    stg.status === 'COMPLETE'
                      ? 'bg-neutral-800/80 text-neutral-300 border border-neutral-600/40'
                      : stg.status === 'ACTIVE'
                ...
                <div className="flex items-center gap-3">
                  <span className={`px-2 py-0.5 rounded text-[10px] font-bold ${
                    stg.status === 'COMPLETE' ? 'bg-neutral-800 text-neutral-300' : stg.status === 'ACTIVE' ? 'bg-[#D4AF37]/15 text-[#D4AF37]' : 'text-neutral-600'
                  }`}>
                    {stg.status}
                  </span>
